const translations = {
  es: {
    ...
    hero: { available: "Disponible para trabajar", experience: "1 año y medio de experiencia", description: "apasionado por el desarrollo, la tecnología. Me encanta dar vida a proyectos digitales.", aboutMe: "Sobre Mí", viewProjects: "Ver Proyectos", downloadCV: "Descargar CV" },
    experience: { title: "Experiencia", titleGradient: "Laboral", education: "Educación", current: "Actualidad", developer: "Desarrollador Web", formerFreeAgents: "Fundación FreeAgents (2024 - Ene 2026)", systemsEngineer: "Ingeniero en Sistemas y Computación", python: "Introducción a la Programación en Python I", certifications: "Múltiples Certificaciones", descriptions: { systems: "Estudiante de Ingeniería en Sistemas y Computación, enfocado en desarrollo de software y tecnologías modernas.", python: "Aprendiendo a programar con Python - Fundamentos de programación y desarrollo de software." } },
