const translations = {
  es: {
    ...
    hero: { available: "Disponible para trabajar", tagline: "Ingeniero de Sistemas y desarrollador frontend con experiencia en apps web, automatización y proyectos full-stack. Me apasiona convertir ideas en productos digitales.", profileTitle: "Ingeniero de Sistemas & FrontEnd Developer", aboutMe: "Sobre Mí", viewProjects: "Ver Proyectos", contactMe: "Contáctame", downloadCV: "Descargar CV" },
    ...
    projects: { title: "Mis", titleGradient: "Proyectos", description: "Explora mis proyectos por categoría. Cada uno refleja tecnologías actuales y buenas prácticas de desarrollo.", featuresTitle: "Características Principales", featuresDesc: "Descubre todo lo que esta aplicación tiene para ofrecer.", galleryTitle: "Galería de la Aplicación", galleryDesc: "Un vistazo a la interfaz y experiencia de usuario.", builtWith: "Construido con", goBack: "Volver", featuredSection: "Proyectos destacados", filterAll: "Todos", filterWeb: "Web", filterMobile: "Mobile", noResults: "No hay proyectos en esta categoría.", viewProject: "Ver proyecto", code: "Código", featured: "Destacado" },
    projectsItems: {
      ...
      batteryHook: "Monitorea, analiza y protege la vida útil de tu batería en tiempo real.",
      freeStatus: "Versión 1.2.0 • Gratis",
      batteryFeature1Title: "Alertas Inteligentes",
      batteryFeature1Desc: "Notificaciones personalizadas cuando la batería alcanza niveles críticos o se completa la carga.",
  ...
  en: {
    ...
    hero: { available: "Available for work", tagline: "Systems Engineer and frontend developer experienced in web apps, automation and full-stack projects. I love turning ideas into digital products.", profileTitle: "Systems Engineer & FrontEnd Developer", aboutMe: "About Me", viewProjects: "View Projects", contactMe: "Contact Me", downloadCV: "Download CV" },
    ...
    projects: { title: "My", titleGradient: "Projects", description: "Browse my projects by category. Each one reflects modern technologies and development best practices.", featuresTitle: "Core Features", featuresDesc: "Discover everything this application has to offer.", galleryTitle: "App Gallery", galleryDesc: "A glimpse into the user interface and experience.", builtWith: "Built with", goBack: "Go back", featuredSection: "Featured projects", filterAll: "All", filterWeb: "Web", filterMobile: "Mobile", noResults: "No projects in this category.", viewProject: "View project", code: "Code", featured: "Featured" },
    projectsItems: {
      ...
      battery: "Android app for battery monitoring with alerts, SQLite history, and charts.",
      batteryHook: "Monitor, analyze, and protect your battery life in real-time.",
      freeStatus: "Version 1.2.0 • Free",
      batteryFeature1Title: "Smart Alerts",
      batteryFeature1Desc: "Custom notifications when your battery reaches critical levels or finishes charging.",
